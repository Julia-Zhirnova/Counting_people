...
object_counting_api.sort_cumulative_object_counting_x_axis(cap, detection_graph, category_index, is_color_recognition_enabled, roi, deviation, custom_object_name) # counting all the objects
